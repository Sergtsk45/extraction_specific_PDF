...
description: Code quality standards and refactoring guidelines. Used by refactor agent for improvements and by review agent for quality checks.
---
...
- **refactor** reads this skill before refactoring code
- **reviewer** uses these standards for quality checks
- **worker** follows these guidelines when writing code
- **debugger** applies these principles when fixing issues
