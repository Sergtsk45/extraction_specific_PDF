...
description: Security best practices and guidelines. Used by security-auditor for audits and by all agents when handling authentication, authorization, or sensitive data.
---
...
- **security-auditor** reads this skill before auditing
- **worker** reads when implementing auth, API endpoints, or data handling
- **debugger** reads when fixing security issues
- **reviewer** checks compliance with these guidelines
